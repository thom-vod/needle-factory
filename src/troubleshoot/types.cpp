...
std::string to_string(TroubleshootSessionStatus s) {
    ...
    case TroubleshootSessionStatus::Cancelled:
        return "cancelled";
    case TroubleshootSessionStatus::FailedHookViolation:
        return "failed_hook_violation";
...
Maybe<TroubleshootSessionStatus> parse_troubleshoot_session_status(const std::string& s) {
    ...
    if (v == "failed_hook_violation") return Maybe<TroubleshootSessionStatus>(TroubleshootSessionStatus::FailedHookViolation);
